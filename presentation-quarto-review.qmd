...
- Export clean qmd ignores comments. Include these as html comments.
- Localstorage restore does not restore comments
...
Review on the right, configuration on the left.
...
An important improvement is to edit the markdown including the changes in the editor window. So if text is deleted, it should show up with strikethrough markings when opening it for editing again. Now the resulting text is shown without any markings related to CriticMarkup.
Adding CriticMarkup syntax manually is now seen as an addition of those characters.
