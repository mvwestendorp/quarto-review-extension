...
describe('CSS Build Process', () => {
  ...
  describe('Development Build', () => {
    ...
    it('should have reasonable file size', () => {
      ...
      // Should be between 50-185 KB (with all @imports including translation.css, bottom-drawer.css, margin-comments.css, developer-panel.css, ReviewSubmissionModal form styles, and inline editing styles)
      expect(sizeKB).toBeGreaterThan(50);
      expect(sizeKB).toBeLessThan(185);
    });
  });
